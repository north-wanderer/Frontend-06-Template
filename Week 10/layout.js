...
function layout (element) {
  ...
  if (!style.alginItems || style.alginItems === 'auto') { style.alginItems = 'stretch' }
  ...
  if (!style.aliginContent || style.aliginContent === 'auto') { style.aliginContent = 'stretch' }
  ...
  for (let i = 0; i < items.length; i++) {
    ...
    if (itemStyle.flex) {
      ...
      if (itemStyle[crossSize] !== null && itemStyle[crossSize] !== (void 0)) { crossSpace = Math.max(mainSpace, itemStyle[crossSize]) }
